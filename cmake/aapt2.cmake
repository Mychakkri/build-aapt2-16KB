...
add_executable(aapt2_bin
    ...
    ${SRC_PATH}/aapt2/ValueTransformer.cpp
...
target_include_directories(aapt2_bin PRIVATE
    ${SRC_PATH}/aapt2
...
target_compile_options(aapt2_bin PRIVATE
    -Wno-unused-parameter
    -Wno-missing-field-initializers
    -fno-exceptions 
    -fno-rtti)

target_link_libraries(aapt2_bin
    PRIVATE zopfli
    PRIVATE fmt
)
